Shader "NovelEditor/HoloEffect"
{
    Properties
    {
        ...
        _ColorGap("ColorGap",Range(0,1.0)) = 0.05
        _Alpha ("Alpha", Range(0,1)) = 0.5
        _FrameRate ("FrameRate", Range(0,30)) = 15
        _Strength  ("Strength", Range(0,1)) = 0.1
        _GlitchScale  ("GlitchScale", Range(1,10)) = 2
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float strength = step(abs(noiseX),_Strength);
                noiseX *= strength;
                //グリッチ適用
                ...
                //アルファ操作
                finalColor.a = tex2D(_MainTex, uv).a;
                finalColor*=i.color;
                return finalColor;
            }
            ENDCG
